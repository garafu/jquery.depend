...
(c="operamini",b=/opera mini\/([\d\.]+)/.exec(a)),d=b?b[1]:""):0<=a.indexOf("msie")?(c="msie",d=(b=/msie ([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("firefox")?(c="firefox",d=(b=/firefox\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("chrome")||0<=a.indexOf("crios")?(c="chrome",d=(b=/[chrome|crios]\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("android")?(c="browser",d=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("silk")?(c="silk",d=(b=/silk\/([\d\.]*)/.exec(a))?b[1]:""):0<=a.indexOf("mercury")?
