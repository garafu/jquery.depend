...
""):0<=a.indexOf("mercury")?(c="mercury",d=(b=/mercury\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("safari")?(c="safari",d=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):(c="unknown",d="");b=0<=a.indexOf("arm")?"arm":0<=a.indexOf("win64")?0<=a.indexOf("ia64")?"ia64":"x64":"x86";this.original=c;this[c]=!0;this[b]=!0;this.version=g.__BACKWARD_COMPATIBILITY_ENABLED?d:new e(d)};h.prototype.is=function(a){return"string"===typeof a&&a.toLowerCase()===this.original};k=function(){this.original="";this.initialize(g.navigator.userAgent)};
...
g.console&&g.console.log&&g.console.log('Not implemented default process in "$.depend" function.');return f}})(window,document,jQuery);
