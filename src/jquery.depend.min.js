...
a?this.major>a:"number"!==typeof b?!1:this.minor!==b?this.minor>b:"number"!==typeof c?!1:this.build!==c?this.build>c:"number"!==typeof d?!1:this.revision!==d?this.revision>d:!1};f.prototype.toString=function(){return this.original};h=function(){this.original="";this.version=null;this.initialize(g.navigator.userAgent)};h.prototype.initialize=function(a){var b,c="",d=b="",e=null;a=a.toLowerCase();0<=a.indexOf("opera")||0<=a.lastIndexOf("opr")?(0<=a.indexOf("opera mini")?(c="operamini",b=/opera mini\/([\d\.]+)/.exec(a)):
0<=a.indexOf("opera mobi")?(c="operamobile",b=/version\/([\d\.]+)/.exec(a)):(c="opera",b=/(?:opera|opr)[\s\/]+([\d\.]+)/.exec(a)),e=b?b[1]:""):0<=a.indexOf("edge")?(c="edge",e=(b=/edge\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("msie")||0<=a.indexOf("trident")?(c="msie",e=(b=/(msie|rv:?)\s?([\d\.]+)/.exec(a))?b[2]:""):0<=a.indexOf("firefox")?(c="firefox",e=(b=/firefox\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("chrome")||0<=a.indexOf("crios")?(c="chrome",e=(b=/[chrome|crios]\/([\d\.]+)/.exec(a))?
b[1]:""):0<=a.indexOf("android")?(c="browser",e=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("silk")?(c="silk",e=(b=/silk\/([\d\.]*)/.exec(a))?b[1]:""):0<=a.indexOf("mercury")?(c="mercury",e=(b=/mercury\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("safari")?(c="safari",e=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):(c="unknown",e="");b=0<=a.indexOf("edge")?"edge":0<=a.indexOf("webkit")?"webkit":0<=a.indexOf("trident")?"trident":0<=a.indexOf("presto")?"presto":0<=a.indexOf("khtml")?"khtml":0<=
a.indexOf("gecko")?"gecko":"unknown";d=0<=a.indexOf("arm")?"arm":0<=a.indexOf("win64")?0<=a.indexOf("ia64")?"ia64":"x64":"x86";this.original=c;this[c]=!0;this[b]=!0;this[d]=!0;this.version=!g.__BACKWARD_COMPATIBILITY_ENABLED?new f(e):e};h.prototype.is=function(a){return"string"===typeof a&&a.toLowerCase()===this.original};k=function(){this.original="";this.initialize(g.navigator.userAgent)};k.prototype.initialize=function(a){var b="",c="",d="",e="",c=null;a=a.toLowerCase();(c=/iphone|ipod|ipad|android|windows phone|silk|blackberry|symbian|mobile/.exec(a))?
0<=a.indexOf("silk")?(b="tablet",c="android"):(b=0<=a.indexOf("android")&&0>a.indexOf("mobile")||0<=a.indexOf("ipad")?"tablet":"mobile",c=c[0].replace(" ","")):0<=a.indexOf("windows")?(b="pc",c="windows",e=(d=/windows nt ([\d\.]+)/.exec(a))?d[1]:"",d=0<=a.indexOf("arm")?"arm":0<=a.indexOf("win64")?0<=a.indexOf("ia64")?"ia64":"x64":0<=a.indexOf("wow64")?"x64":"x86"):(0<=a.indexOf("mac")?(b="pc",c="mac"):0<=a.indexOf("linux")?(b="pc",c="linux"):c=b="unknown",d="unknown");this.type=b;this.original=c;
this[b]=!0;this[c]=!0;this[d]=!0;this.version=new f(e)};k.prototype.is=function(a){return"string"===typeof a?(a=a.toLowerCase(),a===this.original||a===this.type):!1};l.browser=new h;l.platform=new k;l.depend=function(){var a,b,c,d;c=arguments;a=0;for(b=c.length;a<b;a++)if(d=c[a],(!0===d.on||d.on===m)&&"function"===typeof d.exe)return d.exe();g.console&&g.console.log&&g.console.log('Not implemented default process in "$.depend" function.');return m}})(window,document,jQuery);
