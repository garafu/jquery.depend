...
a.indexOf("opera mobi")?(c="operamobile",b=/version\/([\d\.]+)/.exec(a)):(c="opera",b=/opera[\s\/]+([\d\.]+)/.exec(a)),e=b?b[1]:""):0<=a.indexOf("msie")||0<=a.indexOf("trident")?(c="msie",e=(b=/[msie|rv] ([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("firefox")?(c="firefox",e=(b=/firefox\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("chrome")||0<=a.indexOf("crios")?(c="chrome",e=(b=/[chrome|crios]\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("android")?(c="browser",e=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):
0<=a.indexOf("silk")?(c="silk",e=(b=/silk\/([\d\.]*)/.exec(a))?b[1]:""):0<=a.indexOf("mercury")?(c="mercury",e=(b=/mercury\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("safari")?(c="safari",e=(b=/version\/([\d\.]+)/.exec(a))?b[1]:""):(c="unknown",e="");b=0<=a.indexOf("webkit")?"webkit":0<=a.indexOf("trident")?"trident":0<=a.indexOf("presto")?"presto":0<=a.indexOf("khtml")?"khtml":0<=a.indexOf("gecko")?"gecko":"unknown";d=0<=a.indexOf("arm")?"arm":0<=a.indexOf("win64")?0<=a.indexOf("ia64")?"ia64":"x64":
"x86";this.original=c;this[c]=!0;this[b]=!0;this[d]=!0;this.version=g.__BACKWARD_COMPATIBILITY_ENABLED?e:new f(e)};h.prototype.is=function(a){return"string"===typeof a&&a.toLowerCase()===this.original};k=function(){this.original="";this.initialize(g.navigator.userAgent)};k.prototype.initialize=function(a){var b="",c="",d="",e="",c=null;a=a.toLowerCase();(c=/iphone|ipod|ipad|android|windows phone|silk|blackberry|symbian|mobile/.exec(a))?0<=a.indexOf("silk")?(b="tablet",c="android"):(b=0<=a.indexOf("android")&&
