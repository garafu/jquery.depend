...
0<=a.indexOf("opera mobi")?(c="operamobile",b=/version\/([\d\.]+)/.exec(a)):(c="opera",b=/(?:opera|opr)[\s\/]+([\d\.]+)/.exec(a)),e=b?b[1]:""):0<=a.indexOf("msie")||0<=a.indexOf("trident")?(c="msie",e=(b=/(msie|rv:?)\s?([\d\.]+)/.exec(a))?b[2]:""):0<=a.indexOf("firefox")?(c="firefox",e=(b=/firefox\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("chrome")||0<=a.indexOf("crios")?(c="chrome",e=(b=/[chrome|crios]\/([\d\.]+)/.exec(a))?b[1]:""):0<=a.indexOf("android")?(c="browser",e=(b=/version\/([\d\.]+)/.exec(a))?
